...
public class MessageTests {
    ...
    test fun testParsing() {
        ...
        checkParseAndToString("p1b 345 333_15 1_2 2 get a!!b${payloadSplitter}3_123 4 set a b c${payloadSplitter}5_555 6 delete a")
        checkParseAndToString("p2b 1 3_333")
    }
